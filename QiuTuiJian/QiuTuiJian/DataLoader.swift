...
class DataLoader {
    ...
    func createEntity() -> Bool {
        ...
        let businessEntity1: BusinessEntity = self.createBusinessEntity(category1, phone:"0200000001", name: "Kai Wang", email: "test1@yangahha.com")
        ...
        let businessEntity2: BusinessEntity = self.createBusinessEntity(category1, phone: nil, name: "Vivian", email: "test2@yangahha.com")
        ...
        let businessEntity3: BusinessEntity = self.createBusinessEntity(category1, phone:"0200000003", name: "Jack Xu", email: nil)
        ...
        let businessEntity4: BusinessEntity = self.createBusinessEntity(category2, phone:"0200000004", name: "Albert Ma", email: "test4@yangahha.com")
        ...
        let businessEntity5: BusinessEntity = self.createBusinessEntity(category2, phone:"0200000005", name: "Teresa", email: "test5@yangahha.com")
        ...
        let businessEntity6: BusinessEntity = self.createBusinessEntity(category3, phone:"0200000006", name: "老刘搬家", email: "test6@yangahha.com")
        ...
        let businessEntity7: BusinessEntity = self.createBusinessEntity(category3, phone:"0200000007", name: "东北搬家", email: "test7@yangahha.com")
        ...
        let businessEntity8: BusinessEntity = self.createBusinessEntity(category3, phone:"0200000008", name: "快捷搬家", email: "test8@yangahha.com")
    ...
    private func createBusinessEntity(category:String, phone: String?, name: String, email: String?) -> BusinessEntity{
